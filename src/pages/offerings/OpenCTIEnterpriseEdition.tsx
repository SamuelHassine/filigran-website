...
import auditIcon from "@/assets/icons/xtm/audit-logging-user-behavior-analytics.svg";
import automationIcon from "@/assets/icons/automation-scenarios.svg";
import managementIcon from "@/assets/icons/continuous-improvement.svg";
import indexingIcon from "@/assets/icons/data-transformation.svg";
import nlpIcon from "@/assets/icons/optimal-response.svg";
...
const featureHighlights: Feature[] = [
  {
    title: "Audit logging and user behavior analytics",
    description: "Effortlessly analyze user activities and platform usage metrics to ensure corporate compliance.",
    icon: auditIcon,
  },
  {
    title: "Automation engine",
    description: "Save time and orchestrate complex data management tasks with user-friendly and self-explanatory GUI. No coding required.",
    icon: automationIcon,
  },
  {
    title: "Organization management and segregation (RBAC)",
    description: "Improve user managed with granular access management from organizational level down to role level.",
    icon: managementIcon,
  },
  {
    title: "Full text indexing",
    description:
      "Improve time to value with advanced indexing capability. It also grants improved searches across structured and unstructured data.",
    icon: indexingIcon,
  },
  {
    title: "Natural Language Processing of data",
    description:
      "Simplify processes of data import and enrichment. Automate the creation of STIX relationship objects to establish meaningful connections effortlessly.",
    icon: nlpIcon,
  },
];
...
type ComparisonRow =
  ...
  | {
      ...
      enterprise: { href: string; label: string };
    };

const comparisonRows: ComparisonRow[] = [
  { type: "boolean", label: "Knowledge management", community: true, enterprise: true },
  { type: "boolean", label: "Investigations and dashboards", community: true, enterprise: true },
  { type: "boolean", label: "Role based access control", community: true, enterprise: true },
  { type: "boolean", label: "Automation and playbooks", community: false, enterprise: true },
  { type: "boolean", label: "LLM & NLP", community: false, enterprise: true },
  { type: "boolean", label: "AI analyst insights & generation", community: false, enterprise: true },
  { type: "boolean", label: "Finished intelligence templating", community: false, enterprise: true },
  { type: "boolean", label: "Dissemination lists", community: false, enterprise: true },
  {
    type: "boolean",
    label: "Multi-organization data segregation and access control list",
    community: false,
    enterprise: true,
  },
  { type: "boolean", label: "Audit logging and user behavior analytics", community: false, enterprise: true },
  { type: "boolean", label: "Full text indexing of documents", community: false, enterprise: true },
  ...
  { type: "text", label: "Customer support", community: "Community support", enterprise: "Filigran support" },
  {
    ...
    community: {
      label: "Download",
      href: "/resources/pdfs/opencti-community-edition-filigran-product-brief-2025-july.pdf",
    },
    enterprise: {
      label: "Download",
      href: "/resources/pdfs/opencti-enterprise-edition-filigran-product-brief-2025-july.pdf",
    },
  },
];
...
const renderComparisonCell = (row: ComparisonRow, column: "community" | "enterprise") => {
  ...
  return (
    <a href={link.href} target="_blank" rel="noopener noreferrer" className="text-cyan hover:underline">
      {link.label}
    </a>
  );
};

const OpenCTIEnterpriseEdition = () => {
  return (
        ...
        <section className="relative overflow-hidden pt-32 pb-16">
          ...
          <div className="container relative z-10 mx-auto px-4 lg:px-8">
            <div className="max-w-3xl mx-auto text-center space-y-6">
              ...
              <h1 className="text-4xl lg:text-5xl font-bold leading-tight text-white">OpenCTI Enterprise Edition</h1>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-3xl space-y-4">
              ...
              <h2 className="text-3xl lg:text-4xl font-bold">Anticipate threats with exclusive features</h2>
              <p className="text-lg text-foreground/70 leading-relaxed">
                Perform more advanced use cases and improve teams' productivity.
              </p>
            </div>
          ...
          <div className="container mx-auto relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-5xl md:text-6xl font-bold mb-6">
                Ready to see OpenCTI <span className="text-gradient-cyan">in action?</span>
              </h2>
...
export default OpenCTIEnterpriseEdition;
